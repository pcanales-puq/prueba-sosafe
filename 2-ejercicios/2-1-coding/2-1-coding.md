1. Escribe el código fuente de una función llamada `esBisiesto`, que en base a una entrada `year` retorne un valor `true` si la entrada corresponde a un año bisiesto, o de lo contrario retorne el valor `false`.
